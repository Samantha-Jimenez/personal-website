      ...
      <div className="w-full bg-background-light-secondary dark:bg-green-announcement overflow-hidden">
        <div className="container mx-auto px-4 py-20">
          ...
          >
              ...
              >
                  Hey, I&apos;m Sam, a full-stack software engineer with a creative soul and a love for movement, music, and meaningful projects. After years of pouring into my career, I&apos;m reconnecting with the things that light me up: fitness, food, storytelling, and self-expression. This website is my space to document that journey, share insights, and tell stories along the way.
                  <br /><br />
                  Right now, I&apos;m working with fellow engineers from the Pursuit Coding Fellowship on a fitness-focused app, <a href="https://motevis.com/" target="_blank" rel="noopener noreferrer" className="dark:text-lime-100 text-lime-500 hover:text-lime-400 dark:hover:text-lime-300 transition-colors"><em>Motevis</em></a>, which helps runners discover local run clubs, weekly runs, and races across New York City. I&apos;m also documenting my journey on <a href="https://www.youtube.com/@aka.jimena" target="_blank" rel="noopener noreferrer" className="dark:text-lime-100 text-lime-500 hover:text-lime-400 dark:hover:text-lime-300 transition-colors"><em>YouTube</em></a>, from moving back to New York and getting back into fitness to building new tech projects, trying creative hobbies, and sharing the books that catch my attention.
              </motion.p>          
          </div>
        </div>
      </div>
