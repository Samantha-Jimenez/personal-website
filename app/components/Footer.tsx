  ...
  return (
    <footer ref={menuRef} className="footer bg-neutral-200 text-black dark:bg-zinc-900 dark:text-gray-200 items-center p-2">
        ...
        <nav className="flex-none w-full justify-end grid-flow-col gap-6 grid-rows-1 md:justify-self-end max-[500px]:justify-center">
            <ul className="menu menu-horizontal px-1 grid-flow-row grid grid-rows-1 grid-cols-12 max-[662px]:grid-cols-5 max-[662px]:grid-rows-2 max-[662px]:justify-self-end">
