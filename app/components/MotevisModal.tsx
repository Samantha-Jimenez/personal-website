  ...
  return (
    <dialog className="modal modal-open" onClick={onClose}>
      <div className="modal-box bg-background-light-main dark:bg-background-modal-dark tracking-wide roboto-mine" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="dark:text-white text-gray-900 roboto-mine !font-light tracking-wide">You are leaving this site to go to <strong>Motevis</strong> — a fitness web app I&apos;m currently building. It&apos;s designed to help users find local run clubs, weekly runs, and races in New York City. <br/> Do you want to continue?</p>
