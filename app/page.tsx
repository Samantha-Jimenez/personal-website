    ...
    <main className="flex min-h-max flex-col gap-4 justify-self-center">
      <div className="relative grid grid-rows-1 grid-cols-1">
        ...
        <div className="row-start-1 col-start-1 inset-0 flex flex-col z-10 px-6 sm:px-24 py-16 h-full">
          <p className="row-start-1 col-start-1 col-span-1 bungee-hairline-regular text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl max-w-max whitespace-nowrap max-[540px]:place-self-center min-[540px]:place-self-start text-white">Samantha</p>
          <p className="row-start-2 col-start-1 col-span-1 bungee-hairline-regular text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl max-w-max whitespace-nowrap max-[540px]:place-self-center min-[540px]:place-self-end text-white">Jimenez</p>
