      ...
      <div className="max-w-3xl mx-auto px-4 pt-8 pb-12">
        ...
        <article className="flex items-start">
          <div>
            ...
            <div className="prose prose-p:text-black prose-headings:text-gray-800 prose-strong:text-gray-900 prose-li:text-gray-800 prose-li:marker:text-gray-500 prose-ul:list-[circle] prose-a:text-gray-600 max-w-none" dangerouslySetInnerHTML={{ __html: content }} />
          </div>
        </article>
      </div>
